...
const NombreDelModulo = "tipoActividadAgendaLegislativa";

class TipoActividadAgendaLegislativaDataService {
    async create(data) {
...
export default new TipoActividadAgendaLegislativaDataService();
