...
import TemaControlPoliticoDataService from "../../../Services/Catalogo/TemaControlPolitico.Service";
...
class TemaControlPoliticos extends Component {
    constructor(props) {
        super(props);
        this.state = {
            tableInfo: {
                columns: [
                    {
                        Header: "Tema de control político",
                        columns: [
                            {
                                Header: "id",
                                accessor: "id",
                    ...
                    },
                    {
                        Header: "Acciones",
                        columns: [
                            auth.tieneModuloPermiso(ModuloPermiso.TemaControl.Obtener) ?
                            {
                                Header: "Editar",
                                id: "editar",
                                accessor: (str) => "editar",
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.TemaControl.Obtener}
                                        DefaultTemplate={
                                            <button
                                                data-toggle="modal"
                            ...
                            auth.tieneModuloPermiso(ModuloPermiso.TemaControl.Eliminar) ?
                            {
                                ...
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.TemaControl.Eliminar}
                                        DefaultTemplate={
                                            <button
                                                data-toggle="modal"
    ...
    saveSubmit = async (e) => {
        ...
        if (this.state.fields["id"] === 0) {
            await TemaControlPoliticoDataService.create(data)
                .then((response) => {
            ...
            await TemaControlPoliticoDataService.update(
    ...
    deleteSubmit = async (e) => {
        ...
        let responseData;
        await TemaControlPoliticoDataService.delete(this.state.fields["id"])
            .then((response) => {
                responseData = response.data;
            })
            .catch(function (error) {
    ...
    getAll = async (idFilterActive, page, rows, search) => {
        ...
        await TemaControlPoliticoDataService.getAll(
            idFilterActive,
            search,
            page,
            rows
    ...
    getByID = async (id) => {
        this.setState({ loading: true });
        await TemaControlPoliticoDataService.get(id)
            .then((response) => {
        ...
        return (
            <div>
                ...
                <ul className="breadcrumb push-down-0">
                    <li>Catálogos</li>
                    <li>Temas de control político</li>
                </ul>
                            ...
                            <div className="panel panel-default ">
                                <div className="panel-heading">
                                    <h3 className="panel-title">
                                        ...
                                        Listado de temas de control político
                                    </h3>
                                    <ul className="panel-controls">
                                        ...
                                        <li>
                                        <ValidarPermiso
                                            IdModuloPermisoValidar={ModuloPermiso.TemaControl.Nuevo}
                                            DefaultTemplate={
                                                <button
                                ...
                                <div className="panel-body">
                                    <div>
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.TemaControl.ObtenerTodos}
                                        DefaultTemplate={
                                            <TableReact
                                                columns={
                                ...
                                >
                                            ...
                                            <div className="form-group">
                                                <div className="col-md-12">
                                                    ...
                                                    <Input
                                                        ...
                                                        inputplaceholder="Ingrese el nombre del tema de control político"
                                            ...
                                            <div className="form-group">
                                                <div className="col-md-12">
                                                    ...
                                                    <Input
                                                        ...
                                                        inputType="text"
                                                        inputClass="form-control"
                                                        inputplaceholder="Ingrese la descripción del tema de control político"
                                                        inputValue={this.state.fields["descripcion"] || ""}
                                                        inputOnchange={(e) => {
                                                            let fields = this.state.fields;
                                                            let errors = this.state.errors;
                                    ...
                                    <div className="row">
                                        <div className="col-md-12 push-up-30">
                                            ...
                                            <ValidarPermiso
                                                IdModuloPermisoValidar={this.state.fields.id === 0 ? ModuloPermiso.TemaControl.Nuevo
                                                    : ModuloPermiso.TemaControl.Modificar}
                                                DefaultTemplate={
                    ...
                    <form action="">
                        <div className="mb-container">
                            <div className="mb-middle">
                                <div className="mb-title"><span className={`fa fa-${this.state.fields.activo ? "eraser" : "check"}`}></span> {this.state.fields.activo ? "Desactivar" : "Activar"} tema de control político</div>
                                <div className="mb-content">
                                    <p>{`¿Está seguro que desea ${this.state.fields.activo ? "desactivar" : "activar"} el tema de control político ${this.state.fields.nombre}? Puede volver a ${this.state.fields.activo ? "activarla" : "desactivarla"} en cualquier otro momento.`}</p>
                                </div>
...
export default TemaControlPoliticos;
