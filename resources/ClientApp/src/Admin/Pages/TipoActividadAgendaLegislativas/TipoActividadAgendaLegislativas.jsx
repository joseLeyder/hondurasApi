...
import TipoActividadAgendaLegislativaDataService from "../../../Services/Catalogo/TipoActividadAgendaLegislativa.Service";
...
class TipoActividadAgendaLegislativas extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            tableInfo: {
                columns: [
                    {
                        Header:
                            "Tipos de actividades para la agenda legislativa",
                        columns: [
                            {
                                Header: "id",
                                accessor: "id",
    ...
    saveSubmit = async (e) => {
        ...
        if (this.state.fields["id"] === 0) {
            await TipoActividadAgendaLegislativaDataService.create(data)
                .then((response) => {
            ...
            await TipoActividadAgendaLegislativaDataService.update(
    ...
    deleteSubmit = async (e) => {
        ...
        let responseData;
        await TipoActividadAgendaLegislativaDataService.delete(
            this.state.fields["id"]
        )
            .then((response) => {
                responseData = response.data;
    ...
    getAll = async (idFilterActive, page, rows, search) => {
        ...
        let tableInfo = this.state.tableInfo;
        await TipoActividadAgendaLegislativaDataService.getAll(
            idFilterActive,
            search,
            page,
            rows
        ...
        await TipoActividadAgendaLegislativaDataService.getTotalRecords(
            idFilterActive,
            search
        )
            .then((response) => {
    ...
    getByID = async (id) => {
        this.setState({ loading: true });
        await TipoActividadAgendaLegislativaDataService.get(id)
            .then((response) => {
        ...
        return (
            <div>
                ...
                <ul className="breadcrumb push-down-0">
                    <li>Catálogos</li>
                    <li>Tipos de actividades para la agenda legislativa</li>
                </ul>
                            ...
                            <div className="panel panel-default ">
                                <div className="panel-heading">
                                    <h3 className="panel-title">
                                        ...
                                        Listado de tipos de actividades para la
                                        agenda legislativa
                                    </h3>
                            ...
                            <div className="modal-header">
                                ...
                                <h4 className="modal-title" id="largeModalHead">
                                    ...
                                    {this.state.fields["id"] === 0
                                        ? "Nueva"
                                        : "Editar"}{" "}
                                    tipo de actividad para la agenda legislativa{" "}
                                </h4>
                            </div>
                                            ...
                                            <div className="form-group">
                                                <div className="col-md-12">
                                                    ...
                                                    <Input
                                                        ...
                                                        inputplaceholder="Ingrese el nombre del tipo de actividad para la agenda legislativa"
                                                        inputValue={
                                                            this.state.fields[
                                                                "nombre"
                                                            ] || ""
                                ...
                                <div className="mb-content">
                                    <p>{`¿Está seguro que desea ${
                                        this.state.fields.activo
                                            ? "desactivar"
                                            : "activar"
                                    } el tipo de actividad para la agenda legislativa ${
...
export default TipoActividadAgendaLegislativas;
