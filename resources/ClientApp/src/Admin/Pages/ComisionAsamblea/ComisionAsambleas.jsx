...
import ComisionAsambleaDataService from "../../../Services/Catalogo/ComisionAsamblea.Service";
...
class ComisionAsambleas extends Component {
    constructor(props) {
        super(props);
                        ...
                        columns: [
                            {
                                ...
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.ComisionAsamblea.Obtener}
                                        DefaultTemplate=
                                            {
                                                <button
                                                    data-toggle="modal"
                            ...
                            },
                            {
                                ...
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.ComisionAsamblea.Eliminar}
                                        DefaultTemplate=
                                            {
                                                <button
                                                    data-toggle="modal"
    ...
    saveSubmit = async (e) => {
        ...
        if (this.state.fields["id"] === 0) {
            await ComisionAsambleaDataService.create(data)
                .then((response) => {
            ...
            await ComisionAsambleaDataService.update(
    ...
    deleteSubmit = async (e) => {
        ...
        let responseData;
        await ComisionAsambleaDataService.delete(this.state.fields["id"])
            .then((response) => {
                responseData = response.data;
            })
            .catch(function (error) {
    ...
    getAll = async (idFilterActive, page, rows, search) => {
        ...
        await ComisionAsambleaDataService.getAll(
            idFilterActive,
            search,
            page,
            rows
        ...
        await ComisionAsambleaDataService.totalrecords(idFilterActive, search)
            .then((response) => {
                            ...
                            <div className="panel panel-default ">
                                <div className="panel-heading">
                                    <h3 className="panel-title">
                                        ...
                                        Listado de comisiones de asambleas
                                    </h3>
                                    <ul className="panel-controls">
                                        ...
                                        <li>
                                            <ValidarPermiso
                                                IdModuloPermisoValidar={ModuloPermiso.ComisionAsamblea.Nuevo}
                                                DefaultTemplate=
                                                    {
                                                        <button
                                ...
                                <div className="panel-body">
                                    <div>
                                        <ValidarPermiso
                                            IdModuloPermisoValidar={ModuloPermiso.ComisionAsamblea.ObtenerTodos}
                                            DefaultTemplate=
                                                {
                                                    <TableReactExtends
                                                        columns={
                    ...
                    <form action="">
                        <div className="mb-container">
                            <div className="mb-middle">
                                <div className="mb-title"><span className={`fa fa-${this.state.fields.activo ? "eraser" : "check"}`}/> {this.state.fields.activo ? "Desactivar" : "Activar"} comisión de asamblea</div>
                                <div className="mb-content">
                                    <p>{`¿Está seguro que desea ${this.state.fields.activo ? "desactivar" : "activar"} la comisión de asamblea ${this.state.fields.nombre}? Puede volver a ${this.state.fields.activo ? "activarla" : "desactivarla"} en cualquier otro momento.`}</p>
                                </div>
                                            ...
                                            <div className="form-group">
                                                <div className="col-md-12">
                                                    ...
                                                    <Input
                                                        ...
                                                        inputplaceholder="Ingrese el nombre de la comisión de asamblea"
                                                        inputValue={
                                                            this.state.fields[
                                                                "nombre"
                                                                ] || ""
                                        ...
                                        <div className="col-md-12 push-up-30">
                                            ...
                                            <ValidarPermiso
                                                IdModuloPermisoValidar={
                                                    this.state.fields["id"] === 0 ?
                                                        ModuloPermiso.ComisionAsamblea.Nuevo
                                                        : ModuloPermiso.ComisionAsamblea.Modificar
                                                }
                                                DefaultTemplate=
                                                    {
...
export default ComisionAsambleas;
