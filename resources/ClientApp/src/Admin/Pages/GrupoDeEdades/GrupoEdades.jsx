...
import GrupoEdadDataService from "../../../Services/Catalogo/GrupoEdad.Service";
...
class GrupoEdades extends Component {
    constructor(props) {
        super(props);
                        ...
                        columns: [
                            {
                                ...
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.GrupoEdad.Obtener}
                                        DefaultTemplate=
                                            {
                                                <button
                                                    data-toggle="modal"
                            ...
                            },
                            {
                                ...
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.GrupoEdad.Eliminar}
                                        DefaultTemplate=
                                            {
                                                <button
                                                    data-toggle="modal"
    ...
    handlerDesactivar = (item) => {
        let desActObj = {
            id: item.id,
            nombre: item.nombre,
            edad_inicial: item.edad_inicial,
            edad_final: item.edad_final,
            activo: item.activo,
        };
        this.setState({
            fields: desActObj,
    ...
    saveSubmit = async (e) => {
        ...
        if (this.state.fields["id"] === 0) {
            await GrupoEdadDataService.create(data)
                .then((response) => {
            ...
            await GrupoEdadDataService.update(this.state.fields["id"], data)
                .then((response) => {
                    responseData = response.data;
                })
                .catch(function (error) {
    ...
    deleteSubmit = async (e) => {
        ...
        let responseData;
        await GrupoEdadDataService.delete(this.state.fields["id"])
            .then((response) => {
                responseData = response.data;
            })
            .catch(function (error) {
    ...
    getAll = async (idFilterActive, page, rows, search) => {
        ...
        let tableInfo = this.state.tableInfo;
        await GrupoEdadDataService.getAll(idFilterActive, search, page, rows)
            .then((response) => {
        ...
        await GrupoEdadDataService.getTotalRecords(idFilterActive, search)
            .then((response) => {
    ...
    getByID = async (id) => {
        this.setState({ loading: true });
        await GrupoEdadDataService.get(id)
            .then((response) => {
                let fields = response.data;
                Object.assign(fields, { user: auth.username() });
                fields.imagen = fields.grupo_edad_imagen;
                this.setState({
                    fields: fields,
                    loading: false,
                });
    ...
    resetFields() {
        ...
        if (document.querySelector(".ImageForMultipleResolutionCloseButton")) {
            document
                .querySelector(".ImageForMultipleResolutionCloseButton")
                .click();
        }
        this.setState({
            fields: fields,
    ...
    // Start handlers for imageForMultipleResolution
                            ...
                            <div className="panel panel-default ">
                                <div className="panel-heading">
                                    ...
                                    <ul className="panel-controls">
                                        ...
                                        <li>
                                            <ValidarPermiso
                                                IdModuloPermisoValidar={ModuloPermiso.GrupoEdad.Nuevo}
                                                DefaultTemplate=
                                                    {
                                                        <button
                                ...
                                <div className="panel-body">
                                    <div>
                                        <ValidarPermiso
                                            IdModuloPermisoValidar={ModuloPermiso.GrupoEdad.ObtenerTodos}
                                            DefaultTemplate=
                                                {
                                                    <TableReactExtends
                                                        columns={
                                            ...
                                            <div className="form-group">
                                                <div className="col-md-4">
                                                    ...
                                                    <Input
                                                        ...
                                                        inputplaceholder="Ingrese el nombre del rango de edad"
                                                        inputValue={
                                                            this.state.fields[
                                                                "nombre"
                                                            ] || ""
                                                ...
                                                <div className="col-md-4">
                                                    ...
                                                    <Input
                                                        divClass="input-group"
                                                        inputName="edad_inicial"
                                                        inputType="text"
                                                        inputClass="form-control"
                                                        inputplaceholder="Ingrese la edad inicial"
                                                        inputValue={
                                                            this.state.fields[
                                                                "edad_inicial"
                                                            ]
                                                ...
                                                <div className="col-md-4">
                                                    ...
                                                    <Input
                                                        divClass="input-group"
                                                        inputName="edad_final"
                                                        inputType="text"
                                                        inputClass="form-control"
                                                        inputplaceholder="Ingrese la edad final"
                                                        inputValue={
                                                            this.state.fields[
                                                                "edad_final"
                                                            ]
                                        ...
                                        <div className="col-md-12 push-up-30">
                                            ...
                                            <ValidarPermiso
                                                IdModuloPermisoValidar={
                                                    this.state.fields["id"] === 0 ?
                                                        ModuloPermiso.GrupoEdad.Nuevo
                                                        : ModuloPermiso.GrupoEdad.Modificar
                                                }
                                                DefaultTemplate=
                                                    {
                    ...
                    <form>
                        <div className="mb-container">
                            <div className="mb-middle">
                                <div className="mb-title"><span className={`fa fa-${this.state.fields.activo ? "eraser" : "check"}`}></span> {this.state.fields.activo ? "Desactivar" : "Activar"} grupo de edad</div>
                                <div className="mb-content">
                                    <p>{`¿Está seguro que desea ${this.state.fields.activo ? "desactivar" : "activar"} el grupo de edad ${this.state.fields.nombre}? Puede volver a ${this.state.fields.activo ? "activarlo" : "desactivarlo"} en cualquier otro momento.`}</p>
                                </div>
