...
import TipoExpedienteDataService from "../../../Services/Catalogo/TipoExpediente.Service";
...
class TipoExpediente extends Component {
                        ...
                        columns: [
                            {
                                ...
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.TipoExpediente.Obtener}
                                        DefaultTemplate=
                                            {
                                                <button
                                                    data-toggle="modal"
                            ...
                            },
                            {
                                ...
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.TipoExpediente.Eliminar}
                                        DefaultTemplate=
                                            {
                                                <button
                                                    data-toggle="modal"
    ...
    saveSubmit = async (e) => {
        ...
        if (this.state.fields["id"] === 0) {
            await TipoExpedienteDataService.create(data)
                .then((response) => {
            ...
            await TipoExpedienteDataService.update(
    ...
    deleteSubmit = async (e) => {
        ...
        let responseData;
        await TipoExpedienteDataService.delete(this.state.fields["id"])
            .then((response) => {
                responseData = response.data;
            })
            .catch(function (error) {
    ...
    getByID = async (id) => {
        ...
        await TipoExpedienteDataService.get(id)
            .then((response) => {
    ...
    getAll = async (idFilterActive, page, rows, search) => {
        ...
        await TipoExpedienteDataService.getAll(
            idFilterActive,
            search,
            page,
            rows
        ...
        await TipoExpedienteDataService.totalrecords(idFilterActive, search)
            .then((response) => {
                            ...
                            <div className="panel panel-default ">
                                <div className="panel-heading">
                                    ...
                                    <ul className="panel-controls">
                                        ...
                                        <li>
                                            <ValidarPermiso
                                                IdModuloPermisoValidar={ModuloPermiso.TipoExpediente.Nuevo}
                                                DefaultTemplate=
                                                    {
                                                        <button
                                ...
                                <div className="panel-body">
                                    <div>
                                        <ValidarPermiso
                                            IdModuloPermisoValidar={ModuloPermiso.TipoExpediente.ObtenerTodos}
                                            DefaultTemplate=
                                                {
                                                    <TableReactExtends
                                                        columns={
                    ...
                    <form action="">
                        <div className="mb-container">
                            <div className="mb-middle">
                                <div className="mb-title"><span className={`fa fa-${this.state.fields.activo ? "eraser" : "check"}`}/> {this.state.fields.activo ? "Desactivar" : "Activar"} tipo de expediente</div>
                                <div className="mb-content">
                                    <p>{`¿Está seguro que desea ${this.state.fields.activo ? "desactivar" : "activar"} el tipo de expediente ${this.state.fields.nombre}? Puede volver a ${this.state.fields.activo ? "activarla" : "desactivarla"} en cualquier otro momento.`}</p>
                                </div>
                                            ...
                                            <div className="form-group">
                                                <div className="col-md-12">
                                                    ...
                                                    <Input
                                                        ...
                                                        inputplaceholder="Ingrese el nombre del tipo de expediente"
                                                        inputValue={
                                                            this.state.fields[
                                                                "nombre"
                                                                ] || ""
                                        ...
                                        <div className="col-md-12 push-up-30">
                                            ...
                                            <ValidarPermiso
                                                IdModuloPermisoValidar={
                                                    this.state.fields["id"] === 0 ?
                                                        ModuloPermiso.TipoExpediente.Nuevo
                                                        : ModuloPermiso.TipoExpediente.Modificar
                                                }
                                                DefaultTemplate=
                                                    {
