...
class EditarAlertaProyectoLey extends Component {
    constructor(props) {
        super(props);        
    ...
    getByID = async (id) => {
        await ProyectoLeyfieldsService.getAlerta(id)
            .then((response) => {
                                            ...
                                            <div className="col-md-9">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <div className="col-md-9">
                                                        <SunEditor
                                                            placeholder="..."
                                                            setContents={ this.state.fields.informacion || "" }
                                                            onChange={(e) => {
                                                                let fields = this.state.fields;
                                                                let errors = this.state.errors;
                                                ...
                                                {
                                                    this.state.fields.url_archivo && (
                                                        <div className={`form-group`}>
                                                            <label className="col-md-3 control-label">Documento actual</label>
                                                            <div className="col-md-9 ">
                                                                <a href={(auth.pathApi() + this.state.fields.url_archivo) } target="_blank" className="btn btn-primary">Ver documento</a>
                                                            </div>                                                    
                                                        </div>
                                                    )
                                                }
...
export default EditarAlertaProyectoLey;
