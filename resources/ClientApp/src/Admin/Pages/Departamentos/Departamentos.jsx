...
import DepartamentoDataService from "../../../Services/Catalogo/Departamento.Service";
...
class Departamentos extends Component {
                        ...
                        columns: [
                            {
                                ...
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.Departamento.Obtener}
                                        DefaultTemplate=
                                            {
                                                <button
                                                    data-toggle="modal"
                            ...
                            },
                            {
                                ...
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.Departamento.Eliminar}
                                        DefaultTemplate=
                                            {
                                                <button
                                                    data-toggle="modal"
    ...
    saveSubmit = async (e) => {
        ...
        if (this.state.fields["id"] === 0) {
            await DepartamentoDataService.create(data)
                .then((response) => {
            ...
            await DepartamentoDataService.update(
    ...
    deleteSubmit = async (e) => {
        ...
        let responseData;
        await DepartamentoDataService.delete(this.state.fields["id"])
            .then((response) => {
                responseData = response.data;
            })
            .catch(function (error) {
    ...
    getAll = async (idFilterActive, page, rows, search) => {
        ...
        let tableInfo = this.state.tableInfo;
        await DepartamentoDataService.getAll(
            idFilterActive,
            search,
            page,
            rows
        ...
        await DepartamentoDataService.getTotalRecords(idFilterActive, search)
            .then((response) => {
    ...
    getByID = async (id) => {
        this.setState({ loading: true });
        await DepartamentoDataService.get(id)
            .then((response) => {
                            ...
                            <div className="panel panel-default ">
                                <div className="panel-heading">
                                    ...
                                    <ul className="panel-controls">
                                        ...
                                        <li>
                                            <ValidarPermiso
                                                IdModuloPermisoValidar={ModuloPermiso.Departamento.Nuevo}
                                                DefaultTemplate=
                                                    {
                                                        <button
                                ...
                                <div className="panel-body">
                                    <div>
                                        <ValidarPermiso
                                            IdModuloPermisoValidar={ModuloPermiso.Departamento.ObtenerTodos}
                                            DefaultTemplate=
                                                {
                                                    <TableReactExtends
                                                        columns={
                                            ...
                                            <div className="form-group">
                                                <div className="col-md-12">
                                                    ...
                                                    <Input
                                                        ...
                                                        inputplaceholder="Ingrese el nombre del departamento"
                                                        inputValue={
                                                            this.state.fields[
                                                                "nombre"
                                                            ] || ""
                                        ...
                                        <div className="col-md-12 push-up-30">
                                            ...
                                            <ValidarPermiso
                                                IdModuloPermisoValidar={
                                                    this.state.fields["id"] === 0 ?
                                                        ModuloPermiso.Departamento.Nuevo
                                                        : ModuloPermiso.Departamento.Modificar
                                                }
                                                DefaultTemplate=
                                                    {
                    ...
                    <form action="">
                        <div className="mb-container">
                            <div className="mb-middle">
                                <div className="mb-title"><span className={`fa fa-${this.state.fields.activo ? "eraser" : "check"}`}></span> {this.state.fields.activo ? "Desactivar" : "Activar"} departamento</div>
                                <div className="mb-content">
                                    <p>{`¿Está seguro que desea ${this.state.fields.activo ? "desactivar" : "activar"} el departamento ${this.state.fields.nombre}? Puede volver a ${this.state.fields.activo ? "activarlo" : "desactivarlo"} en cualquier otro momento.`}</p>
                                </div>
