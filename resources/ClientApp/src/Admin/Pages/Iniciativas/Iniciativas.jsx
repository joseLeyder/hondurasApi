...
import IniciativaDataService from "../../../Services/Catalogo/Iniciativa.Service";
...
class Iniciativas extends Component {
    ...
    saveSubmit = async (e) => {
        ...
        if (this.state.fields["id"] === 0) {
            await IniciativaDataService.create(data)
                .then((response) => {
            ...
            await IniciativaDataService.update(
    ...
    deleteSubmit = async (e) => {
        ...
        let responseData;
        await IniciativaDataService.delete(this.state.fields["id"])
            .then((response) => {
                responseData = response.data;
            })
            .catch(function (error) {
    ...
    getAll = async (idFilterActive, page, rows, search) => {
        ...
        let tableInfo = this.state.tableInfo;
        await IniciativaDataService.getAll(
            idFilterActive,
            search,
            page,
            rows
        ...
        await IniciativaDataService.getTotalRecords(idFilterActive, search)
            .then((response) => {
    ...
    getByID = async (id) => {
        this.setState({ loading: true });
        await IniciativaDataService.get(id)
            .then((response) => {
                                            ...
                                            <div className="form-group">
                                                <div className="col-md-12">
                                                    ...
                                                    <Input
                                                        ...
                                                        inputplaceholder="Ingrese el nombre de la iniciativa"
                                                        inputValue={
                                                            this.state.fields[
                                                                "nombre"
                                                            ] || ""
                            ...
                            <div className="mb-container">
                                <div className="mb-middle">
                                    ...
                                    <div className="mb-content">
                                        <p>{`¿Está seguro que desea ${this.state.fields.activo ? "desactivar" : "activar"} la iniciativa ${this.state.fields.nombre}? Puede volver a ${this.state.fields.activo ? "activarla" : "desactivarla"} en cualquier otro momento.`}</p>
                                    </div>
