...
import GradoEstudioDataService from "../../../Services/Catalogo/GradoEstudio.Service";
...
class GradoEstudios extends Component {
    constructor(props) {
        super(props);
        this.state = {
            tableInfo: {
                        ...
                        columns: [
                            {
                                ...
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.GradoEstudio.Obtener}
                                        DefaultTemplate=
                                            {
                                                <button
                                                    data-toggle="modal"
                            ...
                            },
                            {
                                ...
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.GradoEstudio.Eliminar}
                                        DefaultTemplate=
                                            {
                                                <button
                                                    data-toggle="modal"
    ...
    saveSubmit = async (e) => {
        ...
        if (this.state.fields["id"] === 0) {
            await GradoEstudioDataService.create(data)
                .then((response) => {
            ...
            await GradoEstudioDataService.update(
    ...
    deleteSubmit = async (e) => {
        ...
        let responseData;
        await GradoEstudioDataService.delete(this.state.fields["id"])
            .then((response) => {
                responseData = response.data;
            })
            .catch(function (error) {
    ...
    getAll = async (idFilterActive, page, rows, search) => {
        ...
        await GradoEstudioDataService.getAll(
            idFilterActive,
            search,
            page,
            rows
    ...
    getByID = async (id) => {
        this.setState({ loading: true });
        await GradoEstudioDataService.get(id)
            .then((response) => {
                            ...
                            <div className="panel panel-default ">
                                <div className="panel-heading">
                                    ...
                                    <ul className="panel-controls">
                                        ...
                                        <li>
                                            <ValidarPermiso
                                                IdModuloPermisoValidar={ModuloPermiso.GradoEstudio.Nuevo}
                                                DefaultTemplate=
                                                    {
                                                        <button
                                ...
                                <div className="panel-body">
                                    <div>
                                        <ValidarPermiso
                                            IdModuloPermisoValidar={ModuloPermiso.GradoEstudio.ObtenerTodos}
                                            DefaultTemplate=
                                                {
                                                    <TableReact
                                                        columns={
                                            ...
                                            <div className="form-group">
                                                <div className="col-md-12">
                                                    ...
                                                    <Input
                                                        ...
                                                        inputplaceholder="Ingrese el nombre del grado de estudio"
                                                        inputValue={
                                                            this.state.fields[
                                                                "nombre"
                                                            ] || ""
                                        ...
                                        <div className="col-md-12 push-up-30">
                                            ...
                                            <ValidarPermiso
                                                IdModuloPermisoValidar={
                                                    this.state.fields["id"] === 0 ?
                                                        ModuloPermiso.GradoEstudio.Nuevo
                                                        : ModuloPermiso.GradoEstudio.Modificar
                                                }
                                                DefaultTemplate=
                                                    {
                        ...
                        <form action="">
                            <div className="mb-container">
                                <div className="mb-middle">
                                    <div className="mb-title"><span className={`fa fa-${this.state.fields.activo ? "eraser" : "check"}`}></span> {this.state.fields.activo ? "Desactivar" : "Activar"} grado de estudio</div>
                                    <div className="mb-content">
                                        <p>{`¿Está seguro que desea ${this.state.fields.activo ? "desactivar" : "activar"} el grado de estudio ${this.state.fields.nombre}? Puede volver a ${this.state.fields.activo ? "activarlo" : "desactivarlo"} en cualquier otro momento.`}</p>
                                    </div>
