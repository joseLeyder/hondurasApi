...
import NivelDificultadBlogNdDataService from "../../../Services/Catalogo/NivelDificultadBlogND.Service";
...
class NivelDificultadBlogND extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            tableInfo: {
                columns: [
                    {
                        Header: "Niveles de dificultad blog nuestra democracia",
                        columns: [
                            {
                                Header: "id",
                                accessor: "id",
    ...
    saveSubmit = async (e) => {
        ...
        if (this.state.fields["id"] === 0) {
            await NivelDificultadBlogNdDataService.create(data)
                .then((response) => {
            ...
            await NivelDificultadBlogNdDataService.update(
    ...
    deleteSubmit = async (e) => {
        ...
        let responseData;
        await NivelDificultadBlogNdDataService.delete(this.state.fields["id"])
            .then((response) => {
                responseData = response.data;
            })
            .catch(function (error) {
    ...
    getAll = async (idFilterActive, page, rows, search) => {
        ...
        let tableInfo = this.state.tableInfo;
        await NivelDificultadBlogNdDataService.getAll(
            idFilterActive,
            search,
            page,
            rows
        ...
        await NivelDificultadBlogNdDataService.getTotalRecords(idFilterActive, search)
            .then((response) => {
    ...
    getByID = async (id) => {
        this.setState({ loading: true });
        await NivelDificultadBlogNdDataService.get(id)
            .then((response) => {
        ...
        return (
            <div>
                ...
                <ul className="breadcrumb push-down-0">
                    <li>Catálogos</li>
                    <li>Niveles de dificultad blog nuestra democracia</li>
                </ul>
                            ...
                            <div className="panel panel-default ">
                                <div className="panel-heading">
                                    <h3 className="panel-title">
                                        ...
                                        Listado de niveles de dificultad blog nuestra democracia
                                    </h3>
                            ...
                            <div className="modal-header">
                                ...
                                <h4 className="modal-title" id="largeModalHead">
                                    ...
                                    {this.state.fields["id"] === 0
                                        ? "Nuevo"
                                        : "Editar"}{" "}
                                        nivel de dificultad blog nuestra democracia{" "}
                                </h4>
                            </div>
                                            ...
                                            <div className="form-group">
                                                <div className="col-md-12">
                                                    ...
                                                    <Input
                                                        ...
                                                        inputplaceholder="Ingrese el nombre del nivel de dificultad"
                                                        inputValue={
                                                            this.state.fields[
                                                                "nombre"
                                                            ] || ""
                    ...
                    <form>
                        <div className="mb-container">
                            <div className="mb-middle">
                                <div className="mb-title"><span className={`fa fa-${this.state.fields.activo ? "eraser" : "check"}`}></span> {this.state.fields.activo ? "Desactivar" : "Activar"} nivel de dificultad</div>
                                <div className="mb-content">
                                    <p>{`¿Está seguro que desea ${this.state.fields.activo ? "desactivar" : "activar"} el nivel de dificultad ${this.state.fields.nombre}? Puede volver a ${this.state.fields.activo ? "activarlo" : "desactivarlo"} en cualquier otro momento.`}</p>
                                </div>
...
export default NivelDificultadBlogND;
