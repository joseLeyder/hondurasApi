...
import EstadoProyectoLeyDataService from "../../../Services/Catalogo/EstadoProyectoLey.Service";
...
class EstadoProyectoLeys extends Component {
    constructor(props) {
        super(props);        
        this.state = {
            tableInfo: {
                columns: [
                    {
                        Header: "Estado del proyecto de ley",
                        columns: [
                            {
                                Header: "id",
                                accessor: "id",
                    ...
                    },
                    {
                        Header: "Acciones",
                        columns: [
                            auth.tieneModuloPermiso(ModuloPermiso.EstadoProyectoLey.Obtener) ?
                            {
                                Header: "Editar",
                                id: "editar",
                                accessor: (str) => "editar",
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.EstadoProyectoLey.Obtener}
                                        DefaultTemplate={
                                            <button
                                                data-toggle="modal"
                            ...
                            auth.tieneModuloPermiso(ModuloPermiso.EstadoProyectoLey.Eliminar) ?
                            {
                                ...
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.EstadoProyectoLey.Eliminar}
                                        DefaultTemplate={
                                            <button
                                                data-toggle="modal"
    ...
    saveSubmit = async (e) => {
        ...
        if (this.state.fields["id"] === 0) {
            await EstadoProyectoLeyDataService.create(data)
                .then((response) => {
            ...
            await EstadoProyectoLeyDataService.update(
    ...
    deleteSubmit = async (e) => {
        ...
        let responseData;
        await EstadoProyectoLeyDataService.delete(this.state.fields["id"])
            .then((response) => {
                responseData = response.data;
            })
            .catch(function (error) {
    ...
    getAll = async (idFilterActive, page, rows, search) => {
        ...
        await EstadoProyectoLeyDataService.getAll(
            idFilterActive,
            search,
            page,
            rows
    ...
    getByID = async (id) => {
        this.setState({ loading: true });
        await EstadoProyectoLeyDataService.get(id)
            .then((response) => {
        ...
        return (
            <div>
                ...
                <ul className="breadcrumb push-down-0">
                    <li>Catálogos</li>
                    <li>Estado del Proyecto de Ley</li>
                </ul>
                            ...
                            <div className="panel panel-default ">
                                <div className="panel-heading">
                                    <h3 className="panel-title">
                                        ...
                                        Listado de estados del proyecto de ley
                                    </h3>
                                ...
                                <div className="panel-body">
                                    <div>
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.EstadoProyectoLey.ObtenerTodos}
                                        DefaultTemplate={
                                            <TableReact
                                                columns={
                                ...
                                >
                                            ...
                                            <div className="form-group">
                                                <div className="col-md-12">
                                                    ...
                                                    <Input
                                                        ...
                                                        inputplaceholder="Ingrese el nombre del estado del proyecto de ley"
                                                        inputValue={
                                                            this.state.fields[
                                                                "nombre"
                                                            ] || ""
                                    ...
                                    <div className="row">
                                        <div className="col-md-12 push-up-30">
                                            ...
                                            <ValidarPermiso
                                                IdModuloPermisoValidar={this.state.fields.id === 0 ? ModuloPermiso.EstadoProyectoLey.Nuevo 
                                                    : ModuloPermiso.EstadoProyectoLey.Modificar}
                                                DefaultTemplate={
                        ...
                        <form action="">
                            <div className="mb-container">
                                <div className="mb-middle">
                                    <div className="mb-title"><span className={`fa fa-${this.state.fields.activo ? "eraser" : "check"}`}></span> {this.state.fields.activo ? "Desactivar" : "Activar"} estado del proyecto de ley</div>
                                    <div className="mb-content">
                                        <p>{`¿Está seguro que desea ${this.state.fields.activo ? "desactivar" : "activar"} estado del proyecto de ley ${this.state.fields.nombre}? Puede volver a ${this.state.fields.activo ? "activarlo" : "desactivarlo"} en cualquier otro momento.`}</p>
                                    </div>
...
export default EstadoProyectoLeys;
