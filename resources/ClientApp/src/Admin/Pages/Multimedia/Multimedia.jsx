...
class Multimedia extends Component {
                        ...
                        columns: [
                            {
                                ...
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.Multimedia.Obtener}
                                        DefaultTemplate = {
                                            <a  href={`#/multimedia-editar/${tableProps.row.values.id}`} data-id={tableProps.row.values.id}
                            ...
                            },
                            {
                                ...
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.Multimedia.Eliminar}
                                        DefaultTemplate={
                                            <button
                                            data-toggle="modal"
    ...
    deleteSubmit = async (e) => {
        ...
        let responseData;
        await MultimediaDataService.delete(this.state.data["id"])
            .then((response) => {
    ...
    getAll = async (idFilterActive,page,rows,search)=>{
        this.setState({loading:true});
        let tableInfo = this.state.tableInfo;
        await MultimediaDataService.getAll(idFilterActive,page,rows,search)
            .then(response =>{
                        ...
                        <div className="rowListado">
                            <div className="panel panel-default ">
                                <div className="panel-heading">
                                    <h3 className="panel-title"><span className="fa fa-list"></span> Listado de recursos multimedia</h3>
                                    <ul className="panel-controls">
                                        ...
                                        <li>
                                            <ValidarPermiso
                                                IdModuloPermisoValidar = {ModuloPermiso.Multimedia.Nuevo}
                                                DefaultTemplate = {
                                                    <a href={`#/multimedia-crear`} className="btn btn-primary">
                                ...
                                <div className="panel-body">
                                    <div>
                                    <ValidarPermiso
                                        IdModuloPermisoValidar = {ModuloPermiso.Multimedia.ObtenerTodos}
                                        DefaultTemplate = {
                                            <TableReact
                        ...
                        <form action="">
                            <div className="mb-container">
                                <div className="mb-middle">
                                    <div className="mb-title"><span className={`fa fa-${this.state.data.activo ? "eraser" : "check"}`}></span> {this.state.data.activo ? "Desactivar" : "Activar"} contenido multimedia</div>
                                    <div className="mb-content">
                                        <p>{`¿Está seguro que desea ${this.state.data.activo ? "desactivar" : "activar"} el contenido multimedia ${this.state.data.titulo}? Puede volver a ${this.state.data.activo ? "activarla" : "desactivarla"} en cualquier otro momento.`}</p>
                                    </div>
