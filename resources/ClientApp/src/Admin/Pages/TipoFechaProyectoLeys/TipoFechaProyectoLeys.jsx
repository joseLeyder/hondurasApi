...
import TipoFechaProyectoLeyDataService from "../../../Services/Catalogo/TipoFechaProyectoLey.Service";
...
class TipoFechaProyectoLeys extends Component {
    constructor(props) {
        super(props);        
        this.state = {
            tableInfo: {
                columns: [
                    {
                        Header: "Tipo de Fecha de Proyecto de Ley",
                        columns: [
                            {
                                Header: "id",
                                accessor: "id",
                    ...
                    },
                    {
                        Header: "Acciones",
                        columns: [
                            auth.tieneModuloPermiso(ModuloPermiso.TipoFechaProyectoLey.Obtener) ?
                            {
                                Header: "Editar",
                                id: "editar",
                                accessor: (str) => "editar",
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.TipoFechaProyectoLey.Obtener}
                                        DefaultTemplate={
                                            <button
                                                data-toggle="modal"
                            ...
                            auth.tieneModuloPermiso(ModuloPermiso.TipoFechaProyectoLey.Eliminar) ?
                            {
                                ...
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.TipoFechaProyectoLey.Eliminar}
                                        DefaultTemplate={
                                            <button
                                                data-toggle="modal"
            ...
            dataSelectCorporacion: [
                { value: -1, label: "Seleccione tipo corporación" },
                { value: 1, label: "Cámara" },
                { value: 2, label: "Senado" }
            ],
            selectCorpo: { value: -1, label: "Seleccione tipo corporación" }
        };
    }
    ...
    saveSubmit = async (e) => {
        ...
        if (this.state.fields["id"] === 0) {
            await TipoFechaProyectoLeyDataService.create(data)
                .then((response) => {
            ...
            await TipoFechaProyectoLeyDataService.update(
    ...
    deleteSubmit = async (e) => {
        ...
        let responseData;
        await TipoFechaProyectoLeyDataService.delete(this.state.fields["id"])
            .then((response) => {
                responseData = response.data;
            })
            .catch(function (error) {
    ...
    getAll = async (idFilterActive, page, rows, search) => {
        ...
        await TipoFechaProyectoLeyDataService.getAll(
            idFilterActive,
            search,
            page,
            rows
    ...
    getByID = async (id) => {
        this.setState({ loading: true });
        await TipoFechaProyectoLeyDataService.get(id)
            .then((response) => {
    ...
    handleSelecttipo = async (selectTipo) => {
        let field=this.state.fields;
        field.corporacion_id=selectTipo.value;
        ...
        return (
            <div>
                ...
                <ul className="breadcrumb push-down-0">
                    <li>Catálogos</li>
                    <li>Tipos de Fecha de Proyecto de Ley</li>
                </ul>
                            ...
                            <div className="panel panel-default ">
                                <div className="panel-heading">
                                    <h3 className="panel-title">
                                        ...
                                        Listado de tipos de fecha de proyecto de ley
                                    </h3>
                                    <ul className="panel-controls">
                                        ...
                                        <li>
                                        <ValidarPermiso
                                            IdModuloPermisoValidar={this.state.fields.id === 0 ? ModuloPermiso.TipoFechaProyectoLey.Nuevo : ModuloPermiso.TipoFechaProyectoLey.Modificar}
                                            DefaultTemplate={
                                                <button
                                ...
                                <div className="panel-body">
                                    <div>
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.TipoFechaProyectoLey.ObtenerTodos}
                                        DefaultTemplate={
                                            <TableReact
                                                columns={
                            ...
                            <div className="modal-header">
                                ...
                                <h4 className="modal-title" id="largeModalHead">
                                    ...
                                    {this.state.fields["id"] === 0
                                        ? "Nuevo"
                                        : "Editar"}{" "}
                                    tipo de fecha de proyecto de ley{" "}
                                </h4>
                            </div>
                                        ...
                                        <div className="col-md-12">
                                            ...
                                            <label htmlFor="">Nombre</label>
                                                    <Input
                                                        ...
                                                        inputplaceholder="Ingrese el nombre del tipo de fecha de proyecto de ley"
                                            ...
                                            <div className="form-group">
                                            <label>Tipo corporación</label>
                                                    <Select
                                                    divClass=""
                                                    selectplaceholder="Seleccione"
                                                    selectValue={this.state.selectCorpo}
                                                    selectOnchange={this.handleSelecttipo}
                                                    selectoptions={
                        ...
                        <form action="">
                            <div className="mb-container">
                                <div className="mb-middle">
                                    <div className="mb-title"><span className={`fa fa-${this.state.fields.activo ? "eraser" : "check"}`}></span> {this.state.fields.activo ? "Desactivar" : "Activar"} tipo de fecha de proyecto de ley</div>
                                    <div className="mb-content">
                                        <p>{`¿Está seguro que desea ${this.state.fields.activo ? "desactivar" : "activar"} el tipo de fecha de proyecto de ley ${this.state.fields.nombre}? Puede volver a ${this.state.fields.activo ? "activarla" : "desactivarla"} en cualquier otro momento.`}</p>
                                    </div>
...
export default TipoFechaProyectoLeys;
