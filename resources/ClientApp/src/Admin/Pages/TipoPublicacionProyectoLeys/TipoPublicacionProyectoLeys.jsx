...
import TipoPublicacionProyectoLeyDataService from "../../../Services/Catalogo/TipoPublicacionProyectoLey.Service";
...
class TipoPublicacionProyectoLeys extends Component {
    constructor(props) {
        super(props);        
        this.state = {
            tableInfo: {
                columns: [
                    {
                        Header: "Tipo de Publicación de Proyecto de Ley",
                        columns: [
                            {
                                Header: "id",
                                accessor: "id",
                    ...
                    },
                    {
                        Header: "Acciones",
                        columns: [
                            auth.tieneModuloPermiso(ModuloPermiso.TipoPublicacionProyectoLey.Obtener) ?
                            {
                                Header: "Editar",
                                id: "editar",
                                accessor: (str) => "editar",
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.TipoPublicacionProyectoLey.Obtener}
                                        DefaultTemplate={
                                            <button
                                                data-toggle="modal"
                            ...
                            auth.tieneModuloPermiso(ModuloPermiso.TipoPublicacionProyectoLey.Eliminar) ?
                            {
                                ...
                                Cell: (tableProps) => (
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.TipoPublicacionProyectoLey.Eliminar}
                                        DefaultTemplate={
                                            <button
                                                data-toggle="modal"
    ...
    saveSubmit = async (e) => {
        ...
        if (this.state.fields["id"] === 0) {
            await TipoPublicacionProyectoLeyDataService.create(data)
                .then((response) => {
            ...
            await TipoPublicacionProyectoLeyDataService.update(
    ...
    deleteSubmit = async (e) => {
        ...
        let responseData;
        await TipoPublicacionProyectoLeyDataService.delete(this.state.fields["id"])
            .then((response) => {
                responseData = response.data;
            })
            .catch(function (error) {
    ...
    getAll = async (idFilterActive, page, rows, search) => {
        ...
        await TipoPublicacionProyectoLeyDataService.getAll(
            idFilterActive,
            search,
            page,
            rows
    ...
    getByID = async (id) => {
        this.setState({ loading: true });
        await TipoPublicacionProyectoLeyDataService.get(id)
            .then((response) => {
        ...
        return (
            <div>
                ...
                <ul className="breadcrumb push-down-0">
                    <li>Catálogos</li>
                    <li>Tipo Publicación de Proyecto de Ley</li>
                </ul>
                            ...
                            <div className="panel panel-default ">
                                <div className="panel-heading">
                                    <h3 className="panel-title">
                                        ...
                                        Listado de tipo de publicaciones de proyecto de ley
                                    </h3>
                                    <ul className="panel-controls">
                                        ...
                                        <li>
                                        <ValidarPermiso
                                            IdModuloPermisoValidar={ModuloPermiso.TipoPublicacionProyectoLey.Nuevo}
                                            DefaultTemplate={
                                                <button
                                ...
                                <div className="panel-body">
                                    <div>
                                    <ValidarPermiso
                                        IdModuloPermisoValidar={ModuloPermiso.TipoPublicacionProyectoLey.ObtenerTodos}
                                        DefaultTemplate={
                                            <TableReact
                                                columns={
                            ...
                            <div className="modal-header">
                                ...
                                <h4 className="modal-title" id="largeModalHead">
                                    ...
                                    {this.state.fields["id"] === 0
                                        ? "Nuevo"
                                        : "Editar"}{" "}
                                    tipo de publicación de proyecto de ley{" "}
                                </h4>
                            </div>
                                ...
                                >
                                            ...
                                            <div className="form-group">
                                                <div className="col-md-12">
                                                    ...
                                                    <Input
                                                        ...
                                                        inputplaceholder="Ingrese el nombre del tipo de publicación de proyecto de ley"
                                    ...
                                    <div className="row">
                                        <div className="col-md-12 push-up-30">
                                            ...
                                            <ValidarPermiso
                                                IdModuloPermisoValidar={this.state.fields.id === 0 ? ModuloPermiso.TipoPublicacionProyectoLey.Nuevo 
                                                    : ModuloPermiso.TipoPublicacionProyectoLey.Modificar}
                                                DefaultTemplate={
                        ...
                        <form action="">
                            <div className="mb-container">
                                <div className="mb-middle">
                                    <div className="mb-title"><span className={`fa fa-${this.state.fields.activo ? "eraser" : "check"}`}></span> {this.state.fields.activo ? "Desactivar" : "Activar"} tipo de publicación de proyecto de ley</div>
                                    <div className="mb-content">
                                        <p>{`¿Está seguro que desea ${this.state.fields.activo ? "desactivar" : "activar"} el tipo de publicación de proyecto de ley ${this.state.fields.nombre}? Puede volver a ${this.state.fields.activo ? "activarla" : "desactivarla"} en cualquier otro momento.`}</p>
                                    </div>
...
export default TipoPublicacionProyectoLeys;
