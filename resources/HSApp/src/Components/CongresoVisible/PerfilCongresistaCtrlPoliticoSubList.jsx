...
const PerfilCongresistaCtrlPoliticoSubList = ({ data = [1,2], propiedades, params = [], link = "#", bootstrapClass = "col-md-6", handler, pageSize = 8, pageExtends = 1, totalRows = 0 }) => {
                                            ...
                                            return (
                                                <div className="lg:w-1/2 lg:px-4">
                                                    ...
                                                    <div 
                                                        ...
                                                        <div dangerouslySetInnerHTML={{ __html:  getObjectValueByString(val.text, elemento.data) === null
                                                    ...
                                                    ? "No disponible" : getObjectValueByString(val.text, elemento.data)}}></div>
                                                            {/* {getObjectValueByString(val.text, elemento.data) === null
                                                    || getObjectValueByString(val.text, elemento.data) === ""
                                                    || getObjectValueByString(val.text, elemento.data) === undefined
...
export default PerfilCongresistaCtrlPoliticoSubList;